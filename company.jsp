		...
		<tbody>
			<tr>
				<td style="padding-left:45px">
					<a href="insert.html">ADD EVENTS
					<img src="add.png" style="height:8%;padding-left:20px;">
					</a>
				</td>
				<td style="padding-left:20px">
					<a href="display.jsp">DISPLAY EVENTS
					<img src="list.png" style="height:10%;padding-left:20px;">
					</a>
				</td>
			</tr>
		</tbody>
